...
from sqlalchemy.orm import Mapped, mapped_column, relationship  # ← relationship импортирован
...
class ShopItem(Base):
    ...
    # Этап 10.2: Связь с Item для загрузки данных о предмете через selectinload
    item: Mapped["Item"] = relationship("Item", lazy="select")  # ← FIX: добавлен relationship
    __table_args__ = (
